...
<template>
  <div
    class="group rounded-xl shadow-lg hover:shadow-xl cursor-pointer mb-10 sm:mb-0 bg-ternary-dark"
    @click="redirectToUrl"
  >
    ...
    <div class="text-center px-4 py-6">
      <p
        class="font-general-semibold text-xl text-ternary-light font-semibold mb-2"
      >
        {{ project.title }}
      </p>
      <span class="font-general-medium text-lg text-ternary-light">{{
        project.description
      }}</span>
    </div>
  </div>
