...
<template>
  <div class="flex flex-col items-center">
    ...
    <div
      class="absolute flex items-center justify-center w-8 h-8 transform -translate-x-1/2 -translate-y-4 bg-purple-500 rounded-full dark:bg-gray-700 left-1/2 lg:translate-y-[4px]"
    >
